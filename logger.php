    ...
    public function get_web_page( $url )
	{
   	...
   	public function logexecution($methodname, $query=''){
		...
		if ($conn->connect_error) {
		    die("Connection failed While DB insertion: " . $conn->connect_error);
		} 
		$time = @date('Ymd:H:i:s');
		$sql = "INSERT INTO qoslog (called_time, method_name, run_time)
		VALUES ($time, $methodname, '$execution_time')";
